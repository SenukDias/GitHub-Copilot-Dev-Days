...
Your event name should follow this format: `GitHub Copilot Dev Days | [City Name]`. For example, if your event is in São Paulo, use: `GitHub Copilot Dev Days | São Paulo`.
